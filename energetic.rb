...
# respective place.
bot = Discordrb::Bot.new token: 'ODgzNjQ0NjE3MTMwNjQ3NTYy.YTM8Lg.ZVuWbG2o1T2jgQyO5KUiwlSqrII'
...
bot.message(with_text: 'help!') do |event|
  event.respond 'По пятницам не подаю!'
end

bot.message(with_text: 'help!!') do |event|
  event.respond 'Уйди, противный человек!'
end

bot.message(with_text: 'help!!!') do |event|
  event.respond 'Достал, кожаный мешок!'
end
